# -*- coding: utf-8 -*-
"""
Created on Sun Dec 11 17:32:38 2016
...
certainityp=['Tenacity','Leveling Terms','Collectivity','Insistence']
certainityn=['Diversity','Exclusion' ,'Liberation']
...
p=np.asarray(a-b)
np.savetxt("certainity.csv", a, delimiter=",")