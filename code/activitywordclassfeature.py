...
activityp=['agression','Accomplishment', 'Communication',' Motion']
activityn=['Cognitive','Passivity','Embellishment']
...
p=np.asarray(a-b)
np.savetxt("extrafeatures.csv", a, delimiter=",")